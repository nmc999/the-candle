...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Get current click count - use maybeSingle instead of single to handle missing stories
    ...
    // If story doesn't exist, just log it and return success (don't crash)
    if (!story) {
      console.log(`Story ${storyId} not found, skipping tracking`);
      return {
        statusCode: 200,
        headers: {
        ...
        body: JSON.stringify({ success: true, message: 'Story not found' })
      };
    }
